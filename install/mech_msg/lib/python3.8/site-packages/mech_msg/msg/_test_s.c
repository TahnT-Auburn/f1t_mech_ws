...
bool mech_msg__msg__test__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mech_msg.msg._test.Test", full_classname_dest, 23) == 0);
  }
  mech_msg__msg__Test * ros_message = _ros_message;
  {  // test
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * mech_msg__msg__test__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Test */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mech_msg.msg._test");
  ...
  mech_msg__msg__Test * ros_message = (mech_msg__msg__Test *)raw_ros_message;
  {  // test
    PyObject * field = NULL;
