...
#ifndef MECH_MSG__MSG__DETAIL__LAT_ERR__FUNCTIONS_H_
#define MECH_MSG__MSG__DETAIL__LAT_ERR__FUNCTIONS_H_
...
#endif  // MECH_MSG__MSG__DETAIL__LAT_ERR__FUNCTIONS_H_
