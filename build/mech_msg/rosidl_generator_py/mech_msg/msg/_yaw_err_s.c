...
bool mech_msg__msg__yaw_err__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mech_msg.msg._yaw_err.YawErr", full_classname_dest, 28) == 0);
  }
  ...
  {  // yaw_err
    ...
    ros_message->yaw_err = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * mech_msg__msg__yaw_err__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of YawErr */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mech_msg.msg._yaw_err");
  ...
  {  // yaw_err
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->yaw_err);
    {
