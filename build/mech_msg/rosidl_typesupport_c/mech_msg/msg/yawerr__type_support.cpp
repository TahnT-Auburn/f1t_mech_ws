...
static const _Yawerr_type_support_symbol_names_t _Yawerr_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mech_msg, msg, Yawerr)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mech_msg, msg, Yawerr)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mech_msg, msg, Yawerr)() {
  return &::mech_msg::msg::rosidl_typesupport_c::Yawerr_message_type_support_handle;
}
