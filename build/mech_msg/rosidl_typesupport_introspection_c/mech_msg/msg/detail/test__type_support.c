...
#include <stddef.h>
#include "mech_msg/msg/detail/test__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Test__rosidl_typesupport_introspection_c__Test_message_member_array[1] = {
  {
    ...
    offsetof(mech_msg__msg__Test, test),  // bytes offset in struct
    NULL,  // default value
