...
{
  new (message_memory) mech_msg::msg::Test(_init);
}

void Test_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mech_msg::msg::Test *>(message_memory);
  typed_message->~Test();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Test_message_member_array[1] = {
  {
    ...
    offsetof(mech_msg::msg::Test, test),  // bytes offset in struct
...
{
  return &::mech_msg::msg::rosidl_typesupport_introspection_cpp::Test_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mech_msg, msg, Test)() {
  return &::mech_msg::msg::rosidl_typesupport_introspection_cpp::Test_message_type_support_handle;
}
