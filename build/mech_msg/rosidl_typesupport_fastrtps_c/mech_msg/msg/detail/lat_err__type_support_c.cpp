...
#include "mech_msg/msg/detail/lat_err__rosidl_typesupport_fastrtps_c.h"
...
using _LatErr__ros_msg_type = mech_msg__msg__LatErr;
...
static uint32_t _LatErr__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mech_msg__msg__LatErr(
...
{
  return max_serialized_size_mech_msg__msg__LatErr(
    full_bounded, 0);
}
