...
{
  new (message_memory) custom_msg::msg::LatErr(_init);
}

void LatErr_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msg::msg::LatErr *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LatErr_message_member_array[1] = {
  {
    ...
    offsetof(custom_msg::msg::LatErr, laterr),  // bytes offset in struct
...
{
  return &::custom_msg::msg::rosidl_typesupport_introspection_cpp::LatErr_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msg, msg, LatErr)() {
  return &::custom_msg::msg::rosidl_typesupport_introspection_cpp::LatErr_message_type_support_handle;
}
