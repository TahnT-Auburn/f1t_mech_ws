...
#include <stddef.h>
#include "custom_msg/msg/detail/lat_err__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember LatErr__rosidl_typesupport_introspection_c__LatErr_message_member_array[1] = {
  {
    ...
    offsetof(custom_msg__msg__LatErr, laterr),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers LatErr__rosidl_typesupport_introspection_c__LatErr_message_members = {
  ...
  "LatErr",  // message name
  1,  // number of fields
  sizeof(custom_msg__msg__LatErr),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_msg, msg, LatErr)() {
