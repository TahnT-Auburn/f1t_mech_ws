...
#include "custom_msg/msg/detail/lat_err__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msg::msg::LatErr & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg::msg::LatErr & ros_message)
{
  // Member: laterr
  cdr >> ros_message.laterr;
...
{
  auto typed_message =
    static_cast<const custom_msg::msg::LatErr *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msg::msg::LatErr *>(
    untyped_ros_message);
...
{
  return &custom_msg::msg::typesupport_fastrtps_cpp::_LatErr__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg, msg, LatErr)() {
  return &custom_msg::msg::typesupport_fastrtps_cpp::_LatErr__handle;
}
