...
static const _YawErr_type_support_symbol_names_t _YawErr_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, img_proc, msg, YawErr)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, img_proc, msg, YawErr)),
  }
};
...
{
  return &::img_proc::msg::rosidl_typesupport_cpp::YawErr_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, img_proc, msg, YawErr)() {
  return get_message_type_support_handle<img_proc::msg::YawErr>();
}
