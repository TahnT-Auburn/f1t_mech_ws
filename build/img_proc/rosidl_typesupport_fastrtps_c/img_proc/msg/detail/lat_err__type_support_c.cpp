...
#include "img_proc/msg/detail/lat_err__rosidl_typesupport_fastrtps_c.h"
...
using _LatErr__ros_msg_type = img_proc__msg__LatErr;
...
size_t get_serialized_size_img_proc__msg__LatErr(
  const void * untyped_ros_message,
...
static uint32_t _LatErr__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_img_proc__msg__LatErr(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_img_proc
size_t max_serialized_size_img_proc__msg__LatErr(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_img_proc__msg__LatErr(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, img_proc, msg, LatErr)() {
